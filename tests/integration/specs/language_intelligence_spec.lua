...
T["SQL language intelligence should be available"] = require("tests.helpers").async(function()
  local bufnr = vim.api.nvim_get_current_buf()
  test_utils.await(function(callback)
    require("sqlserver").disconnect(bufnr, callback)
  end)
  ...
  -- IntelliSense readiness precedes the background semantic model becoming
  -- queryable on a newly connected document.
  utils.defer_async(3000)
